...
int main(int argc, char **argv)
{
    ...
    // message_filters::Subscriber<sensor_msgs::Image> left_sub(nh, "/zed2/zed_node/left_raw/image_raw_color", 1);
    // message_filters::Subscriber<sensor_msgs::Image> right_sub(nh, "/zed2/zed_node/right_raw/image_raw_color", 1);
